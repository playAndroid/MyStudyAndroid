...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
         ...
         * 3,之后执行onResume()方法;
         *
         * 比如:在此注册一个BroadcastReceiver来监控影响UI的改变.或加载一些资源等.
         */
    }
